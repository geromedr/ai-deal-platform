...
serve(async (req) => {
  ...
  try {
    ...
    const contextResponse = await fetch(
      `${Deno.env.get("SUPABASE_URL")}/functions/v1/get-deal-context`,
      {
        method: "POST",
        headers: {
...
`
    ...
    if (decision.action === "update_deal_stage") {
      ...
      await fetch(`${Deno.env.get("SUPABASE_URL")}/functions/v1/update-deal-stage`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${Deno.env.get("SUPABASE_ANON_KEY")}`
    ...
    if (decision.action === "create_task") {
      ...
      await fetch(`${Deno.env.get("SUPABASE_URL")}/functions/v1/create-task`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${Deno.env.get("SUPABASE_ANON_KEY")}`
    ...
    if (decision.action === "log_communication") {
      ...
      await fetch(`${Deno.env.get("SUPABASE_URL")}/functions/v1/log-communication`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${Deno.env.get("SUPABASE_ANON_KEY")}`
    ...
    if (decision.action === "add_financial_snapshot") {
      ...
      await fetch(`${Deno.env.get("SUPABASE_URL")}/functions/v1/add-financial-snapshot`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${Deno.env.get("SUPABASE_ANON_KEY")}`
